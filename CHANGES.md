...
## 1.4.0 (2021-08-04)
- Feat: Added `vue-index` (it's easier to remove things than to add them in) and a couple of demo pages.
- Feat: Added `vercel.json` that works with `vue-index`. You can now publish this template on Vercel and everything Just Works.
